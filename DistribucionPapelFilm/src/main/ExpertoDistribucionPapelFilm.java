...
public class ExpertoDistribucionPapelFilm {
    ...
    public void GuardarProveedor(DTOProveedor dtoNuevo)
    {
                ...
                List<DTOProveedor> listaAVerificar = new ArrayList<>();
                for(DTOProveedor prov : listaAVerificar)
                {
                    if (prov.getCodigoDTOProveedor() != nuevoProveedor.getCodigoProveedor()) 
                    {   
                        if (nuevoProveedor.getCodigoProveedor() !=0 && nuevoProveedor.getCorreoProveedor()!=null && nuevoProveedor.getDireccionProveedor()!=null && nuevoProveedor.getTelefonoProveedor()!=0)
                        {
